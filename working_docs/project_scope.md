...
- Phase 4 - Single-guideline full-processing engine: Module 4.1 complete after REV-012; Module 4.2 not started and now eligible to begin; later engine modules are not started.
