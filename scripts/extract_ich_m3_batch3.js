...
const batch3Data = JSON.parse(fs.readFileSync(path.resolve(__dirname, "ich_m3_batch3_data.json"), "utf8"));
...
async function main() {
  console.log("=== Running 3-Pass Extraction on ICH M3(R2) Batch 3 (Sections 8~12) ===");
  ...
  console.log("\n==================================================");
  console.log("Successfully completed ICH M3(R2) Batch 3!");
