...
3. Items the verification pipeline flagged as `needs_review` or otherwise unresolved (`docs/product_roadmap.md` §2.5/§2.6) — extraction/review is agent-driven by default, not gated on human read-through
