...
Selection ranks reviewed candidates by the section/topic explicitly named in the question, compatible answer intent, then resolved evidence distance — never by question frequency or a fixed test set.
