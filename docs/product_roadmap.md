...
This document was drafted alongside an independent audit at `docs/audit_2026-08-18.md`. Read that first if you want the evidence; this document is the decision built on top of it.
...
- **Extraction: move to schema-constrained LLM extraction starting at M1, not deferred.** Manual curation (the source of the audited governance cost — roughly one governance entry per 2.5-2.7 structured records, `docs/audit_2026-08-18.md` §3) cannot cover a multi-regulator corpus — this isn't a trend preference, it's a volume requirement. Mechanics:
