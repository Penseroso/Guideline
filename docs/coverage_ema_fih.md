# Document Coverage Manifest: EMA FIH Guideline

**Document Code**: `EMA/CHMP/SWP/28367/07 Rev. 1`  
**Document ID**: `ema_fih`  
**Document Title**: *Guideline on strategies to identify and mitigate risks for first-in-human and early clinical trials with investigational medicinal products*  
**Source PDF**: `source_pdfs/EMA guideline-strategies-identify-and-mitigate-risks-first-human-and-early-clinical-trials-investigational-medicinal-products-revision-1_en.pdf` (Total 22 pages)  
**Status**: In Progress (M3 Phase 1)
...
| **7.4** | Dose escalation | p. 13 | `COMPLETED` | 증량 비율, 노출도 기반 증량 (11 KR, 15 Cond) |
