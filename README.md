...
- `data/`: the reviewed guideline bundles, the source JSON Schema (`data/guidelines/`, `data/schemas/`), and the declarative document/section scope ontology (`data/ontology/`).
