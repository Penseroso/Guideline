 ...
 * Cross-Guideline Comparison Engine.
...
function formatComparativeAnswer(compMatch) {
  ...
  // That violated TPP §1.1/§1.3(4)/§1.4. This renders only what's grounded
  // in `docResults` above; the line below is structural framing, not a
  // regulatory claim.
