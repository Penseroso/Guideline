...
(function (root, factory) {
  ...
  const ko = {
    ...
    semanticCoverageTitle: "세부 항목 커버리지",
    semanticCoverageStatusComplete: "이 답변이 다뤄야 할 세부 항목을 모두 포함했습니다.",
    semanticCoverageStatusPartial: "일부 세부 항목이 빠졌을 수 있습니다.",
    semanticCoverageStatusAmbiguous: "질문에서 조건이 명확하지 않아 여러 항목을 함께 표시합니다.",
    semanticCoverageStatusUnavailable: "이 답변에서 확인되는 세부 항목이 없습니다.",
    semanticCoverageMissingLabel: "확인되지 않은 항목",
    semanticCoverageComparisonLabel: "비교 축 근거",
    semanticCoverageFraction: "{covered}/{total} 확인",
    semanticCoverageDetailLabel: "추가 세부 항목",
    curatedOverviewTitle: "개요",
    answerTitle: "답변",
    evidenceTitle: "근거",
  ...
  const en = {
    ...
    semanticCoverageStatusComplete: "This answer includes every sub-item it should cover.",
    semanticCoverageStatusPartial: "Some sub-items may be missing.",
    semanticCoverageStatusAmbiguous: "The question didn't specify a condition, so multiple items are shown together.",
    semanticCoverageStatusUnavailable: "No sub-items for this topic were found in this answer.",
    ...
    semanticCoverageDetailLabel: "Additional detail",
    curatedOverviewTitle: "Overview",
    answerTitle: "Answer",
